...
def on_open(ws):
    def run(*args):
        ws.send('{"action": "subscribe", "symbols": "GSPC, IXIC, FTSE, DJI, NDX"}')

    thread.start_new_thread(run, ())


def connect_websocket():
    ws = websocket.WebSocketApp("ws://ws.eodhistoricaldata.com/ws/index?api_token=90j6w31n68ka2.91057371",
