...
<head>
    ...
    <style>
        ...
        #realtime_historical, #crypto, #price_scale{
            margin-right:10px;
        }
    </style>
</head>
...
<body>
    ...
    <div class="select-options">
        <input type="date" class="start_date" style="display:none;">
        <input type="date" class="end_date" style="display:none;">
        ...
        <select name="crypto" id="crypto">
            <option value="AAPL" selcted>AAPL</option>
            <option value="MSFT">MSFT</option>
            <option value="TSLA">TSLA</option>
            <option value="EURUSD">EURUSD</option>
            <option value="BTC-USD">BTC-USD</option>
            <option value="ETH-USD">ETH-USD</option>
            <option value="GSPC">SPX</option>
        ...
        <div class="live-indicator">
            <div class="live-indicator-live-text">Live</div>
            <div class="live-indicator-text"></div>
        </div>
    </div>

    <div class="ohlc">
        <div class="tickname"></div>
        <div class="timescale">1 minute</div>
    ...
    <script type="text/javascript">
        ...
        setTimeout(() => {
            setInterval(() => {
                $(".live-indicator-live-text").toggleClass('active');
            }, 500);    
        }, 5000);
        // END - Live blinker
        ...
        $(document).ready(function() {
                    ...
                    // Set Live Indicator text to null
            ...
            $("#crypto").change(function() {
                ...
                // Hide live indicator on change ticker to get updated status
                $(".live-indicator").hide();
        ...
        function loadChart(startDate, endDate, crypto) {
            ...
            axios.get(api_url+'/api/api_get_chart_histoical_live_data.php', {
                    params: {
                        startDate: startDate,
                        endDate: endDate,
                        crypto: crypto
